          ...
          <React.Fragment key={i}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, flexShrink: 0 }}>
              <div style={{
                ...
                background: i < step ? '#D4AF37' : i === step ? '#0d9488' : '#fff',
                border: `2px solid ${i < step ? '#D4AF37' : i === step ? '#0d9488' : '#e5e5ec'}`,
              ...
              <div style={{
                ...
                color: i < step ? '#b8960c' : i === step ? '#0d9488' : '#6b7280',
            ...
            {i < total - 1 && (
              <div style={{
                ...
                background: i < step ? '#D4AF37' : '#e5e5ec',
